...
config['LEARNING_RATES'] = [
                            (5, config['INITIAL_LEARNING_RATE'] / 100.0),
...
config['DATA_DIR_TRAIN'].append(('/data1/martinez/MUSDB18/train', False))
...
config['DATA_DIR_VALID'].append(('/data1/martinez/MUSDB18/val', False))
